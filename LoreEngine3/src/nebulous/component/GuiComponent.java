...
public abstract class GuiComponent {
	...
	public GuiComponent(Texture texture, int x, int y, float size, boolean preserveEdges) {
		this(texture, x, y, 0, 0, size, size, preserveEdges);
	}
	
	public GuiComponent(Texture texture, int x, int y, float width, float height, boolean preserveEdges) {
		this(texture, x, y, 0, 0, width, height, preserveEdges);
	}
	
	public GuiComponent(Texture texture, int x, int y, float rotX, float rotY, float width, float height, boolean preserveEdges) {
