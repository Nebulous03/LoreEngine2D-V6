...
public abstract class BackgroundElement extends GameObject2D{
	...
	public BackgroundElement(float pixelX, float pixelY, float scaleX, float scaleY, Texture texture) {
