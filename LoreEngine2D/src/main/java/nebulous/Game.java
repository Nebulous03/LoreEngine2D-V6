...
/**
 * The Game class is the top of the LoreEngine architecture. Extend this class
 * and run the start() method to run your game.
 * 
 * @author Nebulous
 */
...
public abstract class Game {
	...
	/**
	 * Constructor: Do not override this method. Use the init methods to add
	 * pre-game logic.
	 * 
	 * @author Nebulous
	 */
	...
	/**
	 * Runs as soon as the game starts, before OpenGL is initialized. You may
	 * modify window / game parameters here. Note: GL Context has NOT been
	...
	/**
	 * Runs after the engine and OpenGL is initialized. Note: GL Context has
	 * been created.
	 * 
	 * @author Nebulous
	 */
	...
	/**
	 * Runs every game tick. Do not run level or component update methods
	 * through this method. They are updated internally.
	 * 
	 * @param game
	 * @param delta
	 * @author Nebulous
	...
	/**
	 * Stops the game loop. Call stop() to safely stop the loop and terminate
	 * OpenGL before exiting.
	 * 
	 * @author Nebulous
	 */
	...
	/**
	 * Pauses the game loop. Only the game update method will be called while
	 * pause is active. Use the unpause() method to unpause. Do not use start()
	 * 
	 * @author Nebulous
	 */
